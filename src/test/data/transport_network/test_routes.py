...
@pytest.mark.parametrize('update_route, extend_result', [
    (Route(id= 6, name='Route 1', count_stops=5, count_transport_on_line=0),
     [
        Route(id= 2, name='Route 1', count_stops=5, count_transport_on_line=0),
        Route(id= 3, name='Route 1', count_stops=5, count_transport_on_line=0),
        Route(id= 4, name='Route 1', count_stops=5, count_transport_on_line=0),
...
def test_update(update_route, extend_result):
    
    
    Routes.update(update_route)
    assert  Routes.get_all_routes() == extend_result
